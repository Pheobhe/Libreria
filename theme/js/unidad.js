...
$('#consultar').click(function(){
  cargarSelectNombreUnidades();
});


$('#consultaNombre').on("select2:select", function(e) { 
   consultarUnidadesNombre();
});


function cargarSelectNombreUnidades(){
  $(function () {
     $.ajax({
            async: true,
            type: "POST",
...
function consultarUnidadesNombre(){
