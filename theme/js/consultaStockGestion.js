...
//cargar todos los Productos con su stock

function cargarTodoStockGestion(){
  $.ajax({
      async: true,
      type: "POST",
      url:'Producto/getAllStockGestion', 
      cache: false,
      data: 'json',
      dataType: 'json',        
    })
...
function cargarTodoStockIdGestion(){
  $.ajax({
      async: true,
      type: "POST",
      url:'Producto/getAllStockIdGestion', 
      cache: false,
      data: 'json',
      dataType: 'json',        
    })
...
function cargarSinStock(){
  $.ajax({
      async: true,
      type: "POST",
      url:'Producto/getSinStockGestion', 
      cache: false,
      data: 'json',
      dataType: 'json',        
    })
 ...
 // console.log("Aaa");
  var id_producto = $("#selectProducto").val(); 
    ...
    $.ajax({
      async: true,
      type: "POST",
      url:'Producto/getProductoByIdGestion', 
      cache: false,
      data: postData,
      dataType: 'json',        
    })
    .done(function(data) {
      if(!$.isEmptyObject(data)){
        ...
        /*for (var i = 0 ;i<1;i++) {
      	...
      	alert('El stock del Articulo es 0 o no tuvo Movimientos');
      }
...
function cargarProdPorPres(){
  var presentacion = $("#selectPresentacion").val(); 
    ...
    $.ajax({
      async: true,
      type: "POST",
      url:'Producto/getProductoByPreGestion', 
      cache: false,
      data: postData,
      dataType: 'json',        
    })
    .done(function(data) {
      ...
      if(!$.isEmptyObject(data)){
        ...
        alert("no hay Productos en esa Presentación");
  ...
  var presentacion = $("#selectPresentacion").val(); 
    var postData = {
     ...
     $.ajax({
            async: true,
            type: "POST",
            url:'Producto/getProductosPreGestion', 
            cache: false,
            data: postData,
            dataType: 'json',
      })
