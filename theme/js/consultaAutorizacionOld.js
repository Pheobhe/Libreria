//$(".select2").select2();
cargarSelectAutorizacionesO();

$('#selectAutorizacion').on("select2:select", function(e) {
   cargarAutorizacionesO();
});

//Cargar Selects
function cargarSelectAutorizacionesO()
{
  $("#selectAutorizacion").select2({
    ...
    ajax:{
      url: 'Remito/getAutorizacionesOldSelect2',
      dataType:'json',
      delay:250,
...
function cargarAutorizacionesO(){
