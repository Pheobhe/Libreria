...
function drawRow(rowData,nombreTabla) {
  ...
  $.each(rowData, function( index, value ) {
    ...
    row.append($("<td><button data-toggle='modal' data-target='.consultarRem' type='button'  onclick='verNota("+id+")'  class='btn seleccionar btn-default '><span class='fa fa-list'></span></button></td></tr></tbody>")); 
