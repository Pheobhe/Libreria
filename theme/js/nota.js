...
//carga de select en consulta en nota de devolucion
...
jQuery.validator.addMethod("specialNota", function (value, element) {
...
function enviarFormulario(){
    ...
    .fail(function() {
        alert("EError. Consulte con el administrador de sistemas.")
    });
  }else{
...
function resetForm(){
  var encab="";
  encab += "<thead><tr><th>Codigo<\/th><th>Producto<\/th><th>Presentación<\/th><th>Cantidad<\/th><th>Tamaño<\/th><th>Inventario<\/th><\/tr><\/thead>";
 ...
 /* $.ajax({
      ...
      //data: {id_producto: "producto"},
        ...
        .done(function(data) {
          ...
          $.getScript("/farmacia/theme/js/nota.js");
        })
        .fail(function() {
          alert("error. Consulte con el administrador de sistemas.")
        });*/
