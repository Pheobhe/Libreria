  ...
  <!-- Content Wrapper. Contains page content -->
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
       ...
       <li class="active">Histórico de Ingresos por Fecha</li>
      </ol>
    </section>
          ...
          <div class="box">
            ...
            <div class="box-body table-responsive no-padding">
             ...
             <table id="tablaPrincipal" class="table table-bordered table-striped table-hover">
               <thead><tr><th>N°Ingreso</th><th>N°Remito</th><th>Fecha</th><th>Proveedor</th><th>Usuario</th><th>Responsable</th><th>Detalle</th></tr></thead>
