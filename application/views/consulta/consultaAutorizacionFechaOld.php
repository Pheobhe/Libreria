    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
       ...
       <li class="active">Histórico de Autorización por Fecha</li>
      </ol>
    </section>
          ...
          <div class="box">
            ...
            <div class="box-body table-responsive no-padding">
             ...
             <table id="tablaPrincipal" class="table table-bordered table-striped table-hover">
               <thead><tr><th>N°Autorizacion</th><th>Fecha</th><th>Destino</th><th>Usuario</th><th>Responsable</th><th>Estado</th><th>Detalle</th></tr></thead>
