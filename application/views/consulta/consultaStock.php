  ...
  <!-- Content Wrapper. Contains page content -->
    ...
    <div class="row" style="margin-top:50px;">
      ...
      <div class="col-xs-6">
        <div id="impresion">
          <!-- <button class="btn btn-app avoid-this" id="showall">
                <i class="ion ion-ios-pricetags"></i> MOSTRAR POR LOTE/FECHA 
          </button> -->
