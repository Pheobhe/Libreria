...
<!-- </li> -->
        ...
        <li class="treeview ">
          <a href="#">
            <i class="fa text-primary fa-gear"></i> <span>Administrador</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          ...
          <ul class="treeview-menu " >
            <li>
              <a href="#"><i class="fa fa-book"></i> Fichas
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
           <ul class="treeview-menu" >
             <li>
             <a href="#"><i class="fa fa-medkit"></i> Productos
             <span class="pull-right-container">
             <i class="fa fa-angle-left pull-right"></i>
              </span>
             </a>
            ...
            <ul class="treeview-menu " >
              ...
              <li><a class="menuadmin" id="nuevoArt" href="#"><i class="fa fa-plus-circle"></i> Nuevo Producto</a></li>
              <li><a class="menuadmin" id="eliminarArt" href="#"><i class="fa fa-trash-o"></i> Eliminar Producto</a></li>
              </ul>
              </li>
 
               <li>
                 <a href="#"><i class="fa fa-hospital-o"></i> Unidades
                  <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                  </span>
                  </a>
               ...
               <ul class="treeview-menu ">
                  <li><a href="#" class="menuadmin" id="nuevoUnidad" ><i class="fa fa-plus-circle"></i> Nueva Unidad</a></li>
                  <li><a href="#" class="menuadmin" id="eliminarUnidad" ><i class="fa fa-trash-o"></i> Eliminar Unidad</a></li>
                  </ul>
                </li>
                ...
                <li>
                  ...
                  <ul class="treeview-menu" >
                   <li><a href="#" class="menuadmin" id="nuevoProv" ><i class="fa fa-plus-circle"></i> Nuevo Proveedor</a></li>
                   <li><a href="#" class="menuadmin" id="eliminarProv" ><i class="fa fa-trash-o"></i> Eliminar Proveedor</a></li>
                  </ul>
                </li>
          ...
          <li class="treeview">
              <a  href="#">
                <i class="fa text-yellow fa-book"></i> <span>Inventario</span>
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
              <ul class="treeview-menu">
                <li><a class="menuadmin" id="inventarioCambio" href="#" ><i class="fa fa-medkit"></i> Cambio Ubicacion</a></li>
                 <li><a class="menuadmin" id="stockMin" href="#" ><i class="fa fa-cubes"></i> Cambio Stock M&iacute;nimo</a></li>
                <!-- <li><a class="menuadmin" id="asignarSeguimiento" href="#" ><i class="fa fa-star"></i> Asignar Seguimiento</a></li>
                <li><a class="menuadmin" id="asignarBloqueo" href="#" ><i class="fa fa-lock"></i> Asignar Bloqueo</a></li>  -->
              </ul>
            </li>


             <li>
              <a href="#"><i class="fa fa-files-o"></i> Ingreso
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
             ...
             <ul class="treeview-menu" >
                <li><a href="#" class="menuadmin" id="ingresoSinRemito"><i class="fa fa-exclamation-triangle"></i>Ingreso Sin Remito</a></li>
                <li><a href="#" class="menuadmin" id="anularMovimiento"><i class="fa fa-remove"></i>Anular Movimiento</a></li>
                <li><a href="#" class="menuadmin" id="anularNota"><i class="fa fa-remove"></i>Anular Nota Devolución</a></li>
              </ul> 
             </li>
<li>
              <a href="#"><i class="fa fa-files-o"></i> Egreso
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
              <ul class="treeview-menu" >
                <!-- <li><a href="#" class="menuadmin" id="egresoSinRemito"><i class="fa fa-exclamation-triangle"></i>Egreso Sin Remito</a></li> -->
                 <li><a href="#" class="menuadmin" id="anularAutorizacion"><i class="fa fa-remove"></i>Anular Autorizacion</a></li> 
                <li><a href="#" class="menuadmin" id="anularRemito"><i class="fa fa-remove"></i>Anular Remitos</a></li>
