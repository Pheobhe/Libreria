  ...
  <!-- Content Wrapper. Contains page content -->
    ...
    <div class="row" style="margin-bottom:50px;">
      ...
      <div class="col-xs-6">
        <button id="anularMov" type="button" class="btn btn-app">
          <i class="fa fa-remove"></i>Anular Movimiento
        </button>
      </div>
    </div> 
    <div class="row">
          ...
          <div class="box">
            ...
            <div class="box-body table-responsive no-padding">
             ...
             <table id="tablaPrincipal" class="table table-bordered table-striped table-hover">
               <thead><tr><th>id</th><th>Nombre</th><th>Unidad</th><th>Cantidad</th></tr></thead>
