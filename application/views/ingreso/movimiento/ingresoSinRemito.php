  ...
  <!-- Content Wrapper. Contains page content -->
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Ingreso Sin Remito</li>
      </ol>
    </section>
                ...
                <div class="col-xs-12 col-md-12">
                  ...
                  <label>Motivo</label>
                    <div class="input-group">
                      ...
                      <select  id="numremito" class="form-control select2" style="width: 100%;">
                        <option>AJUSTE DE STOCK</option>
                        <option>CARGA INICIAL</option>
                        <option>ERROR DE CONTEO</option>        
                        <option>COMPRA CAJA CHICA</option> 
